...
폰 데이터를 PC로 — 무루팅 테더링 (Windows 클라이언트 · 사용 설명서)
...
© JC Globeway · 오픈소스 고지: [tun2socks](https://github.com/xjasonlyu/tun2socks) (MIT), [wintun](https://www.wintun.net) (Prebuilt Binaries License)
